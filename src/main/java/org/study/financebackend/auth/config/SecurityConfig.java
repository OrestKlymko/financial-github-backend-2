package org.study.financebackend.auth.config;
...
import org.study.financebackend.auth.filter.CookieTokenAuthenticationFilter;
import org.study.financebackend.auth.service.AuthenticationService;
import org.study.financebackend.auth.inspector.GoogleOpaqueTokenInspector;
...
public class SecurityConfig {
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOriginPatterns(Arrays.asList("https://financial-tracker-frontend.vercel.app/","https://financial-tracker-frontend.onrender.com","http://localhost:4200","http://localhost:8080","https://financial-github-backend-production.up.railway.app","https://microservice-production-c110.up.railway.app","https://financial-github-frontend-production.up.railway.app"));
